...
function adminEmailHtml(b: any, leadId: string): string {
  ...
  const fields = [
    ...
    ['Lodging Property',Array.isArray(b.lodgingInterested) && b.lodgingInterested.length ? b.lodgingInterested.join(', ') : '—'],
    ...
    ['Cart Pref',       b.cartPref || '—'],
    ['Dining Help',     b.diningHelp || '—'],
    ['Lead ID',         leadId],
...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    const lead = {
      ...
      email:                  body.email,
      phone:                  body.phone,
      contact_preference:     body.contactPreference    || null,
      ...
      lodging_property:       body.lodgingInterested    || [],
      room_config:            body.roomConfig           || null,
      sleeping_config:        body.sleepingConfig       || null,
      total_rounds:           parseInt(body.totalRounds === 'other' ? body.totalRoundsCustom : body.totalRounds) || null,
