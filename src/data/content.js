...
export const siteConfig = {
  ...
  social: {
    og_image: 'https://golfgraeagle.com/wp-images/grizzly-ranch-hero.webp',
  },
};
...
export const courses = [
  {
    ...
    coordinates: { lat: 39.845, lng: -120.4168 },
    altitude: '5,161 ft',
    phone: '(530) 832-4200',
    ...
    description: 'Golf Digest named Grizzly Ranch one of America\'s Top 100 Greatest Public Courses in 2021 — the only Graeagle course on that list. Designed by Bob Cupp and opened in 2005, it plays 7,411 yards through dramatic mountain terrain at 4,800–5,400 feet elevation. Slope 140, rating 74.9. Exposed ridgeline holes, forced carries, and panoramic Sierra views on every hole. Semi-private — access is through packages only.\n\nGrizzly Ranch tee times are limited. The course releases public windows 30 days in advance and they fill within days, particularly for weekend mornings in June through September. Groups booking through GolfGraeagle secure tee times as part of a confirmed package — no hunting for open slots or dealing with waitlists.\n\nThe course plays at 5,161 feet average elevation, which means the ball carries 5–8% farther than at sea level. Bring one less club than you think. The greens are fast — typically stimping at 10–11 in peak season — and the breaks are subtle until they\'re not. First-time players consistently underestimate the slope. Grizzly Ranch golf groups who stay at River Pines Resort are 11 miles from the 1st tee.',
    ...
    faqs: [
      ...
      { q: 'What are the green fees at Grizzly Ranch Golf Club?', a: 'Grizzly Ranch green fees range from approximately $89–$119 in the shoulder season (May and October) to $139–$179 for peak weekend morning tee times in summer (June–September). Cart is included. GolfGraeagle packages start from $299 per golfer and include a confirmed tee time plus lodging.' },
      { q: 'What is the Grizzly Ranch scorecard?', a: 'Grizzly Ranch is a par 72 playing 7,411 yards from the Black tees (rating 74.9, slope 140), 6,893 yards from Blue (rating 72.1, slope 133), 6,309 yards from White (rating 69.3, slope 124), and 5,691 yards from Gold (rating 66.4, slope 115). The course has 10 par 4s, 4 par 3s, and 4 par 5s.' },
      { q: 'Is Grizzly Ranch Golf Club worth playing?', a: 'Grizzly Ranch is widely considered the best course in the Graeagle region and one of the best in Northern California — Golf Digest ranked it among the Top 100 Greatest Public Courses in 2021. The terrain is dramatic, the routing is genuine Bob Cupp, and the views from the ridgeline holes are among the best in the Sierra Nevada. It is a demanding round but a memorable one.' },
      { q: 'What are the reviews for Grizzly Ranch Golf Club?', a: 'Grizzly Ranch holds a 4.8 out of 5 rating based on 177 verified reviews. Golfers consistently cite the elevation changes, forced carries, and ridgeline views as highlights. The main note in negative reviews is difficulty — slope 140 from the tips is challenging, and first-time visitors benefit from playing the White or Gold tees.' },
      { q: 'How long does a round at Grizzly Ranch take?', a: 'A typical round at Grizzly Ranch takes approximately 4 to 4.5 hours for a foursome. The course is semi-private with controlled tee sheets, so pace of play is generally well-managed. Morning rounds in peak season tend to be faster than afternoon rounds. Allow extra time if this is your first visit — the terrain and elevation changes slow groups who are unfamiliar with the layout.' },
      { q: 'What is the dress code at Grizzly Ranch?', a: 'Grizzly Ranch requires collared shirts. Soft spikes only — metal spikes are not permitted. No denim on the course. Golf shorts must be appropriate length. The dress code is enforced at check-in.' },
    ],
  },
  {
    ...
    coordinates: { lat: 39.7643, lng: -120.6054 },
    altitude: '4,372 ft',
    ...
    description: 'Opened in 1968, Graeagle Meadows is where Graeagle golf began. Ellis Van Gorder routed the course through open meadows and ponderosa pines alongside the Feather River — a layout that rewards placement over power. Par 72, 6,759 yards, slope 120, rating 71.4. The most forgiving of the five Graeagle courses, and consistently the best value green fee in the valley.\n\nGraeagle Meadows tee times are the most accessible of any course here. The course is publicly owned and managed — walk-on availability exists most mornings, and group tee times can be reserved weeks in advance. For groups looking to mix a challenging course one day with a friendlier layout the next, Graeagle Meadows is the obvious anchor of a multi-course itinerary.\n\nThe on-site restaurant serves breakfast and lunch daily in season. Carts are available and the pace of play is relaxed by Graeagle standards. If your group includes mixed handicaps, this is the course that keeps everyone in a good mood. Graeagle Meadows golf packages through GolfGraeagle include cart, tee time, and optional lodging at properties within five minutes of the first tee.',
  ...
  },
  {
    ...
    coordinates: { lat: 39.7175, lng: -120.5484 },
    phone: '(530) 836-0394',
    altitude: '4,496 ft',
    ...
    signatureHoles: [
      { hole: 9, par: 4, name: 'The Drivable', description: 'A drivable par 4 measuring 238–310 yards depending on tees. A stream crosses the fairway diagonally from left to right, then runs along the right side of the green. The risk-reward calculus is clear from the tee — clear the stream and you have a makeable birdie; miss right and you are in the water. The most talked-about decision on the course.' },
  ...
  },
  {
    ...
    tier: '$$',
    address: 'Graeagle, CA 96103',
    coordinates: { lat: 39.7932, lng: -120.6555 },
    altitude: '4,423 ft',
    phone: '(530) 836-1420',
  ...
  },
  {
    ...
    coordinates: { lat: 39.7687, lng: -120.525 },
    altitude: '5,035 ft',
...
export const lodging = [
  ...
  },
  {
    ...
    phone: '(530) 836-2552',
    coordinates: { lat: 39.7748, lng: -120.6203 },
    checkinTime: '15:00',
    checkoutTime: '11:00',
    distanceFromGraeagle: '5 min via Hwy 89',
    website: 'https://www.riverpines.com',
    tagline: 'Family-owned Sierra resort — cabins, pool, hot tub, and The Roadhouse on-site. Graeagle Meadows is a short walk.',
    highlights: [
      'Classic rooms, deluxe rooms, cottages, and vacation rentals — flexible for any group size',
      'Large outdoor pool, in-ground hot tub, and outdoor bar',
      'The Roadhouse on-site — bar and grill for group dinners after your round',
      'E-bike rentals on property — explore the Graeagle area on two wheels',
      'Walking distance to Graeagle Meadows Golf Course — the only walkable championship course in the valley',
      'Steps from the Feather River — fishing, hiking, and biking trails right outside',
      'Open year-round · pet-friendly off-season · WiFi throughout',
    ],
    hero: '/wp-images/DJI_0949-Edit.webp',
    images: [
      '/wp-images/DJI_0949-Edit.webp',
      '/wp-images/DJI_0006-Edit.webp',
      '/wp-images/DJI_0021.webp',
      '/wp-images/sign.jpg',
      '/wp-images/pool9.jpg',
      '/wp-images/Pool.jpg',
    ...
    faqs: [
      { q: 'What types of accommodation does River Pines Resort offer?', a: 'River Pines Resort offers classic rooms, deluxe rooms, cottages, and vacation rentals — flexible for golf groups of any size. The resort has been family-owned for over 40 years and is open year-round.' },
      { q: 'Which golf course is closest to River Pines Resort?', a: 'Graeagle Meadows Golf Course is within walking distance of River Pines Resort — the only Graeagle property where you can walk to a championship course. All five courses are within 20 minutes by car.' },
      { q: 'What amenities does River Pines Resort have for golf groups?', a: 'River Pines Resort has a large outdoor pool, in-ground hot tub, outdoor bar, e-bike rentals, and The Roadhouse on-site — a bar and grill ideal for post-round group dinners. Pet-friendly off-season and open year-round.' },
      { q: 'Is River Pines Resort good for large golf groups?', a: 'Yes. With classic rooms, deluxe rooms, cottages, and vacation rentals, River Pines accommodates golf groups ranging from pairs to 60+. GolfGraeagle coordinates room blocks, tee times, and dining reservations as one bundled package.' },
      { q: 'What is the price range for a River Pines Resort golf package?', a: 'GolfGraeagle stay-and-play packages including River Pines Resort and tee times at Graeagle courses start from $299 per golfer, depending on courses selected, room type, and group size. Request a free custom quote.' },
      { q: 'How do I book River Pines Resort for a golf trip to Graeagle?', a: 'GolfGraeagle bundles River Pines Resort with guaranteed tee times at all 5 Graeagle championship courses. Submit a quote request at golfgraeagle.com/request-a-quote and receive a custom itinerary within 24 hours.' },
    ],
    description: 'River Pines Resort has been family-owned for over 40 years and sits along the Feather River in Graeagle, California. Accommodation options include classic rooms, deluxe rooms, cottages, and vacation rentals — flexible for golf groups of any size. On-site amenities include a large outdoor pool, in-ground hot tub, outdoor bar, and e-bike rentals. The Roadhouse is the resort\'s bar and grill, perfect for a post-round meal with your group. Graeagle Meadows Golf Course is a short walk away, and all five Graeagle championship courses are within 20 minutes.',
  },
  {
    ...
    type: 'lodge',
    address: 'Graeagle, CA 96103',
    coordinates: { lat: 39.7932, lng: -120.5316 },
    checkinTime: '15:00',
    checkoutTime: '11:00',
  ...
  },
  {
    ...
    type: 'resort',
    address: '348 Bear Run Rd, Clio, CA 96106',
    coordinates: { lat: 39.7729, lng: -120.5212 },
    checkinTime: '16:00',
    checkoutTime: '12:00',
...
export const dining = [
  ...
  },
  {
    ...
    hours: 'Wed–Sun 5:00–8:30 PM · Mon–Tue Closed',
  ...
  },
  {
    ...
    hours: 'June–October · Dinner seatings 6pm & 8pm · 4-week advance reservation required',
  ...
  // ─── Casual Dining ─────────────────────────────────────
  {
    ...
    hours: 'Seasonal — call River Pines Resort for current hours',
  ...
  },
  {
    ...
    hours: 'Tue–Sun 5:00–8:30 PM · Mon Closed',
  ...
  // ─── Breweries & Bars ───────────────────────────────────
  {
    ...
    hours: 'Daily 4:00–8:00 PM (seasonal)',
  ...
  },
  {
    ...
    hours: 'Thu–Sun seasonal · call ahead to confirm',
...
// ── City Drive Times to Graeagle (verified via Google Routes API, May 2026) ──
export const graeagleDriveTimes = {
  'Reno NV':          { mins: 63,  miles: 60,  display: '1h 3min' },
  'Sacramento CA':    { mins: 156, miles: 146, display: '2h 36min' },
  'San Francisco CA': { mins: 235, miles: 232, display: '3h 55min' },
  'S. Lake Tahoe CA': { mins: 120, miles: 89,  display: '2h' },
  'Truckee CA':       { mins: 55,  miles: 46,  display: '55min' },
};

// ── Course Elevations (verified via Google Elevation API, May 2026) ──
export const courseElevations = {
  'grizzly-ranch':    { ft: 5161, m: 1573 },
  'graeagle-meadows': { ft: 4372, m: 1332 },
  'whitehawk-ranch':  { ft: 4496, m: 1370 },
  'plumas-pines':     { ft: 4423, m: 1348 },
  'nakoma-dragon':    { ft: 5035, m: 1535 },
};

// ── Street View Panorama IDs (verified Sep–Oct 2024 imagery) ──
export const courseStreetView = {
  'grizzly-ranch':    { pano_id: 'F6G4COTxcGMJy1vSQFA-zA', date: '2024-09' },
  'graeagle-meadows': { pano_id: 'oDlET1SmAYyMjG9CuGS6bQ', date: '2024-10' },
  'whitehawk-ranch':  { pano_id: 'a-LSM2WA6rOyOMVBWx35ig', date: '2024-10' },
  'plumas-pines':     { pano_id: 'CfKuhpHvpjU8UALlfRf-Cg', date: '2024-10' },
  'nakoma-dragon':    { pano_id: 'sdlHjxBWpvE8dffNHIpg4w', date: '2024-10' },
};

// ── Google Places IDs (verified May 2026) ──
export const placeIds = {
  'grizzly-ranch':             'ChIJieUsG1AXnIARymVbZ8tOz88',
  'graeagle-meadows':          'ChIJseMy5-5rnIARVg4aaMkNkpA',
  'whitehawk-ranch':           'ChIJoaCVnj5tnIAR13411sdJaf0',
  'plumas-pines':              'ChIJsY5k2LlpnIARqZZ78dcWaXI',
  'nakoma-dragon':             'ChIJMyegY1ETnIARzjlxmyXISkc',
  'river-pines-resort':        'ChIJXXSaV99rnIARizSDOFaxQyA',
  'chalet-view-lodge':         'ChIJnYgrujVrnIARh8N_jhQSA9w',
  'inn-at-nakoma':             'ChIJSVqp7VYTnIARTr3SKxEufoQ',
  'grizzly-grill':             'ChIJdxC5k9VrnIARCuFXVxp2H90',
  'iron-door-restaurant':      'ChIJKYt-nYlonIAR-bFTEjEst8E',
  'sardine-lake-resort':       'ChIJy0o23WBxnIARvCVMJzJFjxY',
  'the-brewing-lair':          'ChIJT7UTa9BrnIARL6dlbOQTbgA',
  'eureka-peak-brewing-co':    'ChIJa42kNskUnIARoGFvi4T1Slg',
  'longboards-bar-and-grill':  'ChIJsY5k2LlpnIARt20O4NugJfY',
  'cuccias':                   'ChIJdTMSD3ZpnIAReau82WE3JnI',
  'mohawk-tavern':             'ChIJlRlww-lpnIARHilOHV8RGXE',
  'roadhouse-at-river-pines':  'ChIJcVW8cHVrnIARNMowMbeRS28',
};
